...
const AboutPage = () => {
    ...
    },
    {
      ...
      data: [
        ...
        },
        {
          name: "Т.Ганцэцэг",
          role: "Тест хөгжүүлэгч",
          description: `СЭМҮТ-ийн Амбулаторийн эрхлэгч, Зөвлөх эмч. АШУҮИС, АУС, сэтгэцийн эрүүл мэндийн тэнхимийн багш, АУ-ны доктор.`,
          image: "/gantsetseg.png",
        },
        {
          name: "Б.Батгэрэл",
          role: "Тест хөгжүүлэгч",
        ...
        },
        {
          ...
          role: "Тест хөгжүүлэгч",
          description:
            "МУИС-ийн Математикийн багш мэргэжлээр төгссөн. 1987 оноос хойш бакалаврын өдрийн хөтөлбөрийн оюутнуудын зөвлөх, хүмүүжүүлэгчээр ажиллаж байгаад гавьяаны амралтандаа гарсан. Одоо СЭЗИС болон “Аксиом Инк” ХХК-ийн зөвлөх багш, сургагч багшаар ажиллаж байна.",
          image: "/ishtseden.png",
        },
        {
          name: "Ш.Эрдэнэбуян",
        ...
        },
        {
          ...
          role: "Тест хөгжүүлэгч",
          description:
            "Японы Хижияма их сургуулийг масс коммуникейшн  мэргэжлээр төгссөн. Хуурамч мэдээллийн эсрэг Монголын анхны талбар болох FactCheck.mn-ийн үүсгэн байгуулагч.",
          image: "/tamir.png",
        },
        {
          name: "Э.Нандин-Эрдэнэ",
          role: "Тест хөгжүүлэгч",
          description: `АШУҮИС-ийг Хүний эмч мэргэжлээр төгссөн, Эх барих эмэгтэйчүүд болон Нөхөн үржихүйн дотоод шүүрэл, үргүйдлийн эмчээр мэргэжил дээшлүүлсэн. Их Британи дахь Дандийгийн Их Сургуульд "Хүний үр хөврөл судлал болон үр шилжүүлэн суулгалт"-аар магистрын зэрэг хамгаалсан. 2017 оноос хойш CLWH үр шилжүүлэн суулгах төвд эмч, судлаачаар ажиллаж байгаа бөгөөд БНСУ, Австри, Их Британи, Ирланд зэрэг улсуудад мэргэжлийнхээ дагуу сургалт, хөтөлбөрүүдэд тогтмол хамрагдсаар байна.`,
          image: "/nandia_e.png",
        },
        {
          name: "Г.Чин-Эрдэнэ",
          role: "Тест хөгжүүлэгч",
          description:
            "Америкийн Нэгдсэн Улсын Вашингтоны их сургуульд компьютерийн шинжлэх ухаанаар суралцаж байгаа, front-end, mobile development, backend чиглэлээр салбарын (industry) туршлагатай.",
          image: "/chinee.jpg",
        },
      ],
    },
  ...
  return (
    <div>
      <title>Бидний тухай / Hire.mn</title>
